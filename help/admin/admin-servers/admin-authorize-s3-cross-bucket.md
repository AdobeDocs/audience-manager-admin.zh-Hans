...
我们可以为客户提供替代方案是[!UICONTROL Cross-Account Bucket Permissions]中的[!DNL Amazon S3]。 [AWS文档](https://docs.aws.amazon.com/AmazonS3/latest/dev/example-walkthroughs-managing-access-example2.html)中介绍了此过程。 要在Audience Manager中启用此替代方法，请执行以下步骤：

1. 转到&#x200B;**[!UICONTROL Servers]**&#x200B;并选择&#x200B;**[!UICONTROL Create Server]**。
1. 在&#x200B;**[!UICONTROL S3]**&#x200B;下拉掩码中选择&#x200B;**[!UICONTROL Protocol/Credentials]**。

...
# 登录到Audience Manager管理 {#log-in-to-audience-manager-admin}
...
1. 通过浏览到以下[!DNL URL]访问Audience Manager [!DNL Admin]工具： [https://admin.demdex.com/](https://admin.demdex.com/)。
